...
public class Dashboard {
    ...
    public Dashboard(TransactionManager transactionManager, CategoryManager categoryManager) {
    ...
    public void displayTransactionsMenu() {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            if (updateTransaction) {
                displayUpdateTransactionMenu(scanner);
            } else {
                displayMainMenu();
            }
    ...
    private void displaySpecificTransactionTable(String transactionID,
    ...
    private void addTransaction(Scanner scanner) {
        ...
        int transactionID = transactionManager.getAllTransactions().size() + 1;
    ...
    private void displayUpdateTransactionMenu(Scanner scanner) {
        int lineNumber = transactionManager.getAllTransactions().size();
        System.out.print("Enter Transaction ID to update (1-" + lineNumber + "): ");
        String transactionIDToUpdate = scanner.next();
        Transaction transactionToUpdate = transactionManager.getSpecificTransactionById(transactionIDToUpdate);
        ...
        while (!isValidOption) {
            displaySpecificTransactionTable(transactionIDToUpdate, transactionToUpdate);
            ...
            switch (categoryOption) {
                case "1":
                    ...
                    transactionManager.updateTransaction(oldTransaction, updatedTransaction, "TransactionType");
                    isValidOption = true;
                    break;
                case "2":
                    ...
                    transactionManager.updateTransaction(oldTransaction, updatedTransaction, "Category");
                    isValidOption = true;
                    break;
                case "3":
                    // Enter Date
                    ...
                    transactionManager.updateTransaction(oldTransaction, updatedTransaction, "Date");
                    isValidOption = true;
                    break;
                case "4":
                    boolean isValidInput = false;
                    ...
                    transactionManager.updateTransaction(oldTransaction, updatedTransaction, "Amount");
                    isValidOption = true;
                    break;
                case "5":
                    String description = "";
                    ...
                    transactionManager.updateTransaction(oldTransaction, updatedTransaction, "Description");
                    isValidOption = true;
                    break;
                case "6":
                    isValidOption = true;
    ...
    private void updateCategory(Scanner scanner) {
        ...
        categoryManager.updateCategory(oldCategory, updatedCategory);
    }
